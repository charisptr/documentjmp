...
<div class="container">
    ...
    <h2>Dokumen Jaya Patriot</h2>
    <ol>
        <li><a href="{{ route('home') }}">Beranda</a></li>
        <li>Dokumen Jaya Patriot</li>
    </ol>
    </div>
                    ...
                    <div class="row" style="padding-bottom: 25px">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target="#modal-add-doc"><i class="bx bx-plus-circle"></i> Tambah Dokumen</button>
                        </div>
                    </div>
                                ...
                                @foreach ($documents as $document)
                                    <tr>                                        
                                        ...
                                        <td class="text-center"><a
                                                href="{{ route('jayapatriot.download', $document->id) }}">Download</a>
                                        </td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                                data-target="#modal-update-doc-{{ $document->id }}"><i class="bx bx-edit"></i> Ubah</button>
                                            <form method="POST" style="display:inline"
                                                action="{{ route('jayapatriot.destroy', $document->id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="btn btn-sm btn-danger button-delete-document"><i class="bx bx-trash"></i> Hapus</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
...
<div class="modal fade" id="modal-add-doc" tabindex="-1" aria-labelledby="modal-add-doc" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('jayapatriot.store') }}" method="post" enctype="multipart/form-data" lang="id">
                @csrf
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="add-doc-folder" value="Jaya Patriot" readonly>
                    </div>
                    <div class="mb-3">
...
@foreach ($documents as $document)
    <div class="modal fade" id="modal-update-doc-{{ $document->id }}" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('jayapatriot.update', $document->id) }}" method="POST"
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="update-doc-folder-{{ $document->id }}" class="col-form-label">Dokumen:</label>
                            <input type="text" class="form-control" id="add-doc-folder" value="Jaya Patriot" readonly>
                        </div>
                        <div class="mb-3">
