...
<div class="container">
    ...
    <h2>Dokumen TB Universal</h2>
    <ol>
        <li><a href="{{ route('home') }}">Beranda</a></li>
        <li>Dokumen TB Universal</li>
    </ol>
    </div>
                                ...
                                @foreach ($documents as $document)
                                    <tr>                                        
                                        ...
                                        <td class="text-center"><a
                                                href="{{ route('tbuniversal.download', $document->id) }}">Download</a>
                                        </td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal"
                                                data-target="#modal-update-doc-{{ $document->id }}"><i class="bx bx-edit"></i> Ubah</button>
                                            <form method="POST" style="display:inline"
                                                action="{{ route('tbuniversal.destroy', $document->id) }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
...
<div class="modal fade" id="modal-add-doc" tabindex="-1" aria-labelledby="modal-add-doc" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('tbuniversal.store') }}" method="post" enctype="multipart/form-data" lang="id">
                @csrf
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="add-doc-folder" value="TB Universal" readonly>
                    </div>
                    <div class="mb-3">
...
@foreach ($documents as $document)
    <div class="modal fade" id="modal-update-doc-{{ $document->id }}" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('tbuniversal.update', $document->id) }}" method="POST"
