...
<head>
    ...
    <title>Jaya Marlin Persada</title>
    ...
    <link rel="stylesheet" type="text/css" href="/storage/assets/DataTables/datatables.min.css" />
    <script type="text/javascript" src="/storage/assets/SweetAlert2/sweetalert2.all.min.js"></script>
