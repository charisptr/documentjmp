...
class PaluUtamaController extends Controller
{
   ...
   {
      $documents = Document::orderBy("expired_at", 'asc')->where('folder_id', 1)->get();
   ...
   public function store(Request $request)
   {
      ...
      return redirect()->route('paluutama.index')->with('success', 'Dokumen berhasil ditambahkan');
   }
   ...
   public function destroy($id)
   {
      ...
      return redirect()->route('paluutama.index')->with('success', 'Dokumen berhasil dihapus');
   }
}
