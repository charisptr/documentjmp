...
class TbUniversalController extends Controller
{
   ...
   {
      $documents = Document::orderBy("expired_at", 'asc')->where('folder_id', 2)->get();
      $folders = Folder::orderBy("name", 'asc')->get();
      return view('document.tbuniversal', compact('documents', 'folders'));
   }
   ...
   public function store(Request $request)
   {
      ...
      return redirect()->route('tbuniversal.index')->with('success', 'Dokumen berhasil ditambahkan');
   }
   ...
   public function update(Request $request, $id)
   {
      ...
      return redirect()->route('tbuniversal.index')->with('success', 'Dokumen berhasil diubah');
   }
   ...
   public function destroy($id)
   {
      ...
      return redirect()->route('tbuniversal.index')->with('success', 'Dokumen berhasil dihapus');
   }
}
